...
class Recorder:
    def __init__(self, keys, enable_hooks=True):
        """Initialize input recorder with keyboard tracking."""
        self.keys = keys
    ...
    def keyboard_recorder(self):
        """Get list of current key states including mouse buttons."""
...
class Controller:
    def __init__(self, speed=5, sensitivity=0.1):
        """Initialize movement controller with speed and mouse sensitivity."""
...
class PlayerController(Controller):
    ...
    def Start(self):
        """Initialize player input recorder and mouse handler."""
    ...
    def record_input(self, key_states, dx, dy):
        """Store input frame in queue for network transmission."""
    ...
    @staticmethod
    def mouse_recorder():
        """Get mouse delta and recenter cursor to screen center."""
        # recenter mouse
...
class ServerController(Controller):
    def Update(self, dt):
        """Process server-side input from client queue."""
        if self.input_queue:
    ...
    def read_input(self):
        """Pop and return oldest input from queue."""
