...
def build_wall_client(position=Vector3(0, 0, 0), size=Vector3(1, 1, 1), rotation=Vector3(0, 0, 0)):
    """Create a wall block with collision."""
    return Object(position=position, size=size, rotation=rotation).add_component(
        [BoxCollider(), Rigidbody(isKinematic=True),
         MeshRander(shape="box", texture="models/blank-concrete-white-wall-texture.jpg", repeat_texture=True)])
...
def client_map():
    ...
    walls = [
        ...
        build_wall_client(size=Vector3(10, floor_height, 1), position=Vector3(0, ground_height, -25.5)),
        build_wall_client(size=Vector3(1, floor_height, 12), position=Vector3(24.5, ground_height, 0)),
        build_wall_client(size=Vector3(1, floor_height, 12), position=Vector3(-24.5, ground_height, 0)),

    ]
    # ── NW BUILDING ──────────────────────────────────────────────
    building_NW_f1 = [
        build_wall_client(size=Vector3(20, floor_height, 1), position=Vector3(15, ground_height, 25.5)),
        build_wall_client(size=Vector3(1, floor_height, 19), position=Vector3(24.5, ground_height, 15.5)),
        build_wall_client(size=Vector3(4, floor_height, 1), position=Vector3(14, ground_height, 6.5)),
        build_wall_client(size=Vector3(5, floor_height, 1), position=Vector3(21.5, ground_height, 6.5)),
        build_wall_client(size=Vector3(1, floor_height, 8), position=Vector3(11.5, ground_height, 10)),
        build_wall_client(size=Vector3(7, floor_height, 1), position=Vector3(8.5, ground_height, 14.5)),
        build_wall_client(size=Vector3(1, floor_height, 3), position=Vector3(5.5, ground_height, 16.5)),
        build_wall_client(size=Vector3(1, floor_height, 4), position=Vector3(5.5, ground_height, 23)),

    ]
    building_NW_f2 = [
        build_wall_client(size=Vector3(7, 1, 4), position=Vector3(18, 0.4, 23), rotation=Vector3(0, 0, -15)),
        build_wall_client(size=Vector3(5, 1, 4), position=Vector3(23.74, 1.286, 23)),
        build_wall_client(size=Vector3(3, 1, 12.75), position=Vector3(22.6, 3.35, 15.86), rotation=Vector3(-20, 0, 0)),
        build_wall_client(size=Vector3(5, 1, 3.2), position=Vector3(21.5, floor_height - 0.5, 8.45)),
        build_wall_client(size=Vector3(13, 1, 10), position=Vector3(12.5, floor_height - 0.5, 20)),
        build_wall_client(size=Vector3(7, 1, 8), position=Vector3(15.5, floor_height - 0.5, 11)),

        build_wall_client(size=Vector3(20, floor_height2, 1), position=Vector3(15, floor2_height, 25.5)),
        build_wall_client(size=Vector3(1, floor_height2, 19), position=Vector3(24.5, floor2_height, 15.5)),
        build_wall_client(size=Vector3(13, floor_height2, 1), position=Vector3(17.5, floor2_height, 6.5)),
        build_wall_client(size=Vector3(1, floor_height2, 19), position=Vector3(10.5, floor2_height, 15.5)),
        build_wall_client(size=Vector3(3, 0.5, 7), position=Vector3(12.5, 6.8, 10.4), rotation=Vector3(-17, 0, 0)),
    ...
    building_SW = [
        build_wall_client(size=Vector3(1, floor_height, 19), position=Vector3(24.5, ground_height, -15.5)),
        build_wall_client(size=Vector3(20, floor_height, 1), position=Vector3(15, ground_height, -25.5)),
        build_wall_client(size=Vector3(1, floor_height, 6), position=Vector3(5.5, ground_height, -22)),
        build_wall_client(size=Vector3(1, floor_height, 5), position=Vector3(5.5, ground_height, -14)),
        build_wall_client(size=Vector3(8, floor_height, 1), position=Vector3(10, ground_height, -12)),
        build_wall_client(size=Vector3(1, floor_height, 1), position=Vector3(13.5, ground_height, -11)),
        build_wall_client(size=Vector3(1, floor_height, 2), position=Vector3(13.5, ground_height, -7)),
        build_wall_client(size=Vector3(10, floor_height, 1), position=Vector3(19, ground_height, -6.5)),
    ]
    ...
    building_mid = [
        ...
        build_wall_client(size=Vector3(3, floor_height, 1), position=Vector3(-3.5, ground_height, 4.5)),
        build_wall_client(size=Vector3(3, floor_height, 1), position=Vector3(3.5, ground_height, 4.5)),
...
def server_map():
    ...
    walls = [
        build_wall(size=Vector3(10, floor_height, 1), position=Vector3(0, ground_height, 25.5)),
        build_wall(size=Vector3(10, floor_height, 1), position=Vector3(0, ground_height, -25.5)),
        build_wall(size=Vector3(1, floor_height, 12), position=Vector3(24.5, ground_height, 0)),
        build_wall(size=Vector3(1, floor_height, 12), position=Vector3(-24.5, ground_height, 0)),
